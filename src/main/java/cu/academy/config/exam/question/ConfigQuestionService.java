...
//    }.getType();
    ...
    public List<ExamQuestionOptionsDto> getExamWithQuestionAndOptions(Long examId) {
        List<ConfigQuestionEntity> configQuestionEntityList = repository.findByExamIdOrderByOrderNum(examId);
